...
function _bsdnTpl(name, author) {
    ...
    return `
            <div class="bsdn_contextMenu" style="display: none;">
                ...
                <hr/>
                <span class="bsdn_contextMenuElement">VepurOVK BDSM///Player 0.1</span>
                <hr/>
                ...
                <span class="bsdn_contextMenuElement" onclick="confirm('да какой нахуй флеш плеер');">About Adobe Flash Player...</span>
            </div>
